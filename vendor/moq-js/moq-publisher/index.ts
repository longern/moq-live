import STYLE_SHEET from "./publisher-moq.css?inline"
...
export class PublisherMoq extends HTMLElement {
	...
	private emitPublishState() {
		this.dispatchEvent(
			new CustomEvent("publishstatechange", {
				detail: { isPublishing: this.isPublishing, namespace: this.namespace },
				bubbles: true,
				composed: true,
			}),
		)
	...
	constructor() {
		...
		this.cameraSelect.id = "cameraSelect"
		this.microphoneSelect.id = "microphoneSelect"
		this.previewVideo.id = "preview"
		this.connectButton.id = "connect"

		this.previewVideo.autoplay = true
		this.previewVideo.playsInline = true
		this.previewVideo.muted = true
		this.connectButton.textContent = "Start Publish"
	...
	private async handleClick() {
		if (!this.isPublishing) {
			...
			try {
				...
				this.emitPublishState()
				this.connectButton.textContent = "Stop Publish"
