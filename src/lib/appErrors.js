const APP_ERROR_MESSAGES = {
  "zh-CN": {
    ...
    cover_image_process_failed: "封面图片处理失败",
    cover_image_unreadable: "封面图片无法读取",
    cover_resize_unsupported: "浏览器不支持封面缩放",
    ...
    follow_status_failed: "关注状态加载失败",
    follow_update_failed: "关注操作失败，请稍后再试",
    follows_list_failed: "关注列表加载失败",
    handle_change_cooldown: "自定义 UID 30 天内只能修改一次",
    handle_taken: "UID 已被占用",
    invalid_avatar_type: "仅支持 JPG、PNG、WebP、AVIF 格式",
    invalid_cover_type: "仅支持 JPG、PNG、WebP、AVIF 格式",
    image_process_failed: "图片处理失败",
    image_resize_unsupported: "浏览器不支持图片缩放",
    image_unreadable: "图片无法读取",
    invalid_display_name: "显示名不能为空，且长度需在 2-24 个字符之间",
    invalid_gender: "性别选项无效",
    invalid_handle: "UID 只能包含小写字母、数字、下划线，长度 6-24，不能为纯数字，且不能以下划线开头或结尾",
    invalid_bio: "个人简介最多 160 个字符",
    invalid_birth_date: "出生日期无效",
    invalid_profile_update: "没有可更新的账号信息",
    invalid_room_title: "直播标题不能超过 80 个字符",
    invalid_room_welcome_message: "欢迎语不能超过 160 个字符",
    ...
    webrtc_playback_url_missing: "WebRTC 播放未配置",
    webrtc_publish_url_missing: "WebRTC 推流未配置",
    webrtc_video_sender_unavailable: "当前 WebRTC 连接无法动态切换摄像头",
    room_creation_failed: "直播间创建失败，请稍后再试",
    room_list_failed: "直播间列表加载失败",
    room_not_found: "直播间不存在",
    room_resolve_failed: "直播间解析失败，请稍后再试",
    room_title_update_failed: "直播标题保存失败，请稍后再试",
    room_welcome_update_failed: "欢迎语保存失败，请稍后再试",
  ...
  en: {
    ...
    cover_image_process_failed: "Cover image processing failed.",
    cover_image_unreadable: "Cover image could not be read.",
    cover_resize_unsupported: "This browser cannot resize cover images.",
    ...
    follow_status_failed: "Follow status failed to load.",
    follow_update_failed: "Follow update failed. Try again later.",
    follows_list_failed: "Follow list failed to load.",
    ...
    image_resize_unsupported: "This browser cannot resize images.",
    image_unreadable: "Image could not be read.",
    invalid_display_name: "Display name is required and must be 2-24 characters.",
    invalid_gender: "Gender option is invalid.",
    ...
    invalid_room_title: "Live title must be 80 characters or fewer.",
    invalid_room_welcome_message: "Welcome message must be 160 characters or fewer.",
    ...
    webrtc_playback_url_missing: "WebRTC playback is not configured.",
    webrtc_publish_url_missing: "WebRTC publishing is not configured.",
    webrtc_video_sender_unavailable: "The current WebRTC connection cannot switch cameras dynamically.",
    ...
    room_title_update_failed: "Live title could not be saved. Try again later.",
    room_welcome_update_failed: "Welcome message could not be saved. Try again later.",
