const CHAT_ERROR_MESSAGES = {
  "zh-CN": {
    ...
    chat_muted: "你已被禁言，暂时无法发言",
    forbidden_stream_update: "仅房主可更新直播状态",
    forbidden_message_retract: "仅房主可撤回评论",
    forbidden_message_mute: "仅房主可禁言观众",
    invalid_message_mute_target: "不能禁言该用户",
    invalid_mute_duration: "禁言时长无效",
  ...
  en: {
    ...
    chat_muted: "You are muted and cannot chat right now.",
    forbidden_stream_update: "Only the room owner can update the stream state.",
    forbidden_message_retract: "Only the room owner can retract comments.",
    forbidden_message_mute: "Only the room owner can mute viewers.",
    invalid_message_mute_target: "This user cannot be muted.",
    invalid_mute_duration: "Invalid mute duration.",
